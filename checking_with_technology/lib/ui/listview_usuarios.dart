...
import 'package:checking_with_technology/pages/drawer.dart';
//import 'package:ejemplo_crud/ui/registro_page.dart';
import 'package:flutter/material.dart';
import 'package:firebase_database/firebase_database.dart';
import 'dart:async';
import 'package:checking_with_technology/ui/usuarios_screen.dart';
import 'package:checking_with_technology/ui/usuarios_information.dart';
import 'package:checking_with_technology/model/usuarios.dart';
                          ...
                          builder: (context)
                          {
                            return AlertDialog(
                              ...
                              content: Column(
                                ...
                                children: <Widget>[
                                  Text('Estás seguro de eliminar al usuario:', style: estiloTexto,),
                                  Text('${items[position].numUsuario} - ${items[position].nombre}', style: estiloTexto,),
